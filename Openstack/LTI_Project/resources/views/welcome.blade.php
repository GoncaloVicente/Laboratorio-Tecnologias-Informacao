...
<div class="d-flex" id="app">
    <div  v-if="this.$store.state.token" class="bg-light border-right" id="sidebar-wrapper">
        <div class="sidebar-heading"><router-link to="/dashboard" class="navbar-brand"><img src="{{URL::asset('/images/logo.png')}}" alt="some text" width=200 height=100/></router-link></div>
